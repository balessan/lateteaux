...
class TravelGear {
	...
	public static function getInstance() {
		if( null == self::$instance ) {
			self::$instance = new TravelGear();
		}
		return self::$instance;
	}

	private function __construct() {
		add_action( 'init', array( $this, 'add_travel_gear_post_type' ) );
    ...
    // Register Custom Post Type
    public function add_travel_gear_post_type() {
    	$labels = array(
    		...
    		'all_items'             => __( 'Tout le matériel', 'ltav' ),
    		'add_new_item'          => __( 'Ajouter un matériel', 'ltav' ),
    		...
    		'view_items'            => __( 'Afficher le matériel', 'ltav' ),
    		...
    		'items_list'            => __( 'Liste du matériel', 'ltav' ),
